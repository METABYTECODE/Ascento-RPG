					...
					for ii = 0, 8 do
						if not hero:GetItemInSlot( ii ) then
							...
							elseif i.name == "item_teleport_boss5" then
								tploc = "tp_b_5"
							elseif i.name == "item_teleport_boss6" then
								tploc = "tp_b_6"
							elseif i.name == "item_teleport_boss7" then
								tploc = "tp_b_7"
							elseif i.name == "item_teleport_boss8" then
								tploc = "tp_b_8"
							elseif i.name == "item_teleport_boss9" then
								tploc = "tp_b_9"
							end
