...
function modifier_crystal_maiden_freezing_field_custom:OnCreated( kv )
    ...
    if IsServer() then
        ...
        self.damageTable = {
            -- victim = target,
            attacker = attacker,
            damage = explosion_damage + (attacker:GetAverageTrueAttackDamage(attacker) * (self:GetAbility():GetSpecialValueFor("int_to_damage")/100)),
        ...
        self.damageTable1 = {
            -- victim = target,
            attacker = attacker,
            damage = (explosion_damage + (attacker:GetAverageTrueAttackDamage(attacker) * (self:GetAbility():GetSpecialValueFor("int_to_damage")/100)))/10,
...
function modifier_crystal_maiden_freezing_field_custom:OnIntervalThink()
    ...
    for _,enemy in pairs(enemies) do
        ...
        self.damageTable1.victim = enemy
