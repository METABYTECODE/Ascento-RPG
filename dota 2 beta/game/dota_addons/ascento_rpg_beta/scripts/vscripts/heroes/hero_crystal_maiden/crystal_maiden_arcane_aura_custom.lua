LinkLuaModifier("modifier_crystal_maiden_arcane_aura_custom", "heroes/hero_crystal_maiden/crystal_maiden_arcane_aura_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_crystal_maiden_arcane_aura_custom_aura", "heroes/hero_crystal_maiden/crystal_maiden_arcane_aura_custom.lua", LUA_MODIFIER_MOTION_NONE)
