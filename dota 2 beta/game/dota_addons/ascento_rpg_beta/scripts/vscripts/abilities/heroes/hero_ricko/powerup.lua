...
LinkLuaModifier(" ricko_modifier_powerup_passive", "abilities/heroes/hero_ricko/powerup", LUA_MODIFIER_MOTION_NONE 	,  ricko_modifier_powerup_passive)
LinkLuaModifier(" ricko_modifier_powerup", "abilities/heroes/hero_ricko/powerup", LUA_MODIFIER_MOTION_NONE 	,  ricko_modifier_powerup)
