    ...
    local caster = keys.caster
        ...
        if caster:GetUnitName() == "npc_dota_hero_skywrath_mage" then
            if  caster:FindAbilityByName("empty1_skymage_datadriven") ~= nil then
                ...
                caster:AddAbility("queenofpain_scream_of_pain_sss_grade_datadriven")
                caster:FindAbilityByName("queenofpain_scream_of_pain_sss_grade_datadriven"):UpgradeAbility(true)
            end
        end
...
function SpecialSpellSkyDestroy( keys )
    local caster = keys.caster
        ...
        if caster:GetUnitName() == "npc_dota_hero_skywrath_mage" then
            if  caster:FindAbilityByName("queenofpain_scream_of_pain_sss_grade_datadriven") ~= nil then
                caster:RemoveAbility("queenofpain_scream_of_pain_sss_grade_datadriven") 
