    ...
    local caster = keys.caster
        ...
        if caster:GetUnitName() == "npc_dota_hero_sven" then
            if  caster:FindAbilityByName("empty1_sven_datadriven") ~= nil then
                ...
                caster:AddAbility("enchant_totem_ss_grade_datadriven")
                caster:FindAbilityByName("enchant_totem_ss_grade_datadriven"):UpgradeAbility(true)
            end
         end
...
function SpecialSpellSvenDestroy( keys )
    local caster = keys.caster
        ...
        if caster:GetUnitName() == "npc_dota_hero_sven" then
            if  caster:FindAbilityByName("enchant_totem_ss_grade_datadriven") ~= nil then
                caster:RemoveAbility("enchant_totem_ss_grade_datadriven") 
