function ChangeHero ( keys )
	...
	local item_to_remove = caster:FindItemInInventory("item_hero_change_to_lonedruid")
	...
	if caster:GetUnitName() ~= "npc_dota_hero_lone_druid" then
        new_hero = PlayerResource:ReplaceHeroWith(caster:GetPlayerOwnerID(), "npc_dota_hero_lone_druid", PlayerResource:GetGold(caster:GetPlayerOwnerID()), 0)
    end
