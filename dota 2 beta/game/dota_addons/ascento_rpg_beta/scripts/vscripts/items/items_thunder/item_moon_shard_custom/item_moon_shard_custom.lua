LinkLuaModifier("modifier_item_moon_shard_custom", "items/items_thunder/item_moon_shard_custom/item_moon_shard_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_moon_shard_custom_stacks", "items/items_thunder/item_moon_shard_custom/item_moon_shard_custom.lua", LUA_MODIFIER_MOTION_NONE)
