LinkLuaModifier("modifier_edible_gem", "items/items_thunder/edible_gem/item_edible_gem.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_edible_gem_sight", "items/items_thunder/edible_gem/item_edible_gem.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_edible_gem_sight_aura", "items/items_thunder/edible_gem/item_edible_gem.lua", LUA_MODIFIER_MOTION_NONE)
