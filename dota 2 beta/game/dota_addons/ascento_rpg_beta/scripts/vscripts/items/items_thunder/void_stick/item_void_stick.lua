...
item_void_stick_2 = item_void_stick
item_void_stick_3 = item_void_stick
item_void_stick_4 = item_void_stick
item_void_stick_5 = item_void_stick
item_void_stick_6 = item_void_stick
LinkLuaModifier( "modifier_item_void_stick", 'items/items_thunder/void_stick/modifiers/modifier_item_void_stick', LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_item_void_stick_cooldown", 'items/items_thunder/void_stick/modifiers/modifier_item_void_stick_cooldown', LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_item_void_stick_astral", 'items/items_thunder/void_stick/modifiers/modifier_item_void_stick_astral', LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_void_stick_active_finish", 'items/items_thunder/void_stick/modifiers/modifier_void_stick_active_finish', LUA_MODIFIER_MOTION_NONE )
