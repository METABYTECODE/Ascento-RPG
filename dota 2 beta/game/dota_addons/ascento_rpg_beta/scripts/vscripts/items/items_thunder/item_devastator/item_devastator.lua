LinkLuaModifier("modifier_item_devastator", "items/items_thunder/item_devastator/item_devastator.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_devastator_buff", "items/items_thunder/item_devastator/item_devastator.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_devastator_debuff", "items/items_thunder/item_devastator/item_devastator.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_item_devastator_buff:OnAttackLanded(event)
    local unit = event.attacker
    local parent = self:GetParent()
    local caster = self:GetCaster()
    local victim = event.target
