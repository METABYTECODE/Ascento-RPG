LinkLuaModifier("modifier_item_pendant_of_chronos", "items/items_thunder/chronos/item_pendant_of_chronos.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_pendant_of_chronos_active", "items/items_thunder/chronos/item_pendant_of_chronos.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_pendant_of_chronos_active_counter", "items/items_thunder/chronos/item_pendant_of_chronos.lua", LUA_MODIFIER_MOTION_NONE)
