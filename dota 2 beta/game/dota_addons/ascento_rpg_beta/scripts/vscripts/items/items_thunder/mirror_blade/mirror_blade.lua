LinkLuaModifier("modifier_mirror_blade", "items/items_thunder/mirror_blade/mirror_blade.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_mirror_blade_doubleattack", "items/items_thunder/mirror_blade/mirror_blade.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_mirror_blade_doubleattack_debuff", "items/items_thunder/mirror_blade/mirror_blade.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_mirror_blade_illusion_modifier", "items/items_thunder/mirror_blade/mirror_blade.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_mirror_blade_doubleattack:GetModifierAttackSpeed_Limit()
    return 1
end
...
function modifier_mirror_blade_illusion_modifier:OnCreated(params)
    ...
    Timers:CreateTimer(0.1, function()
        ...
        FindClearSpaceForUnit(attacker, Vector(self.target:GetAbsOrigin().x-100, self.target:GetAbsOrigin().y-100, self.target:GetAbsOrigin().z), false)
