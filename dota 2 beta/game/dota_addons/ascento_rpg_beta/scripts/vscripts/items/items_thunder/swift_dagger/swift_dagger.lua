LinkLuaModifier("modifier_item_swift_dagger", "items/items_thunder/swift_dagger/swift_dagger.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_swift_dagger_active", "items/items_thunder/swift_dagger/swift_dagger.lua", LUA_MODIFIER_MOTION_NONE)
