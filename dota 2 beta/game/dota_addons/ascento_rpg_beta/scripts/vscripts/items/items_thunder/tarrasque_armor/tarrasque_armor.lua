LinkLuaModifier("modifier_item_tarrasque_armor", "items/items_thunder/tarrasque_armor/tarrasque_armor.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_tarrasque_armor_active", "items/items_thunder/tarrasque_armor/tarrasque_armor.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_tarrasque_armor_stacks", "items/items_thunder/tarrasque_armor/tarrasque_armor.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_item_tarrasque_armor:OnIntervalThink()
    ...
    if mod:GetStackCount() < ability:GetSpecialValueFor("max_charges") then 
        mod:IncrementStackCount() 
    end
    ...
    local mod = caster:FindModifierByName("modifier_item_tarrasque_armor_stacks")
    local red = 0
    if mod ~= nil then
        red = (ability:GetSpecialValueFor("damage_reduction_per_charge_pct") * mod:GetStackCount())
    end

    _G.PlayerDamageReduction[self.accountID][abilityName] = red
