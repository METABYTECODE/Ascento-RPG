LinkLuaModifier("modifier_kings_guard", "items/items_thunder/kings_guard/item_kings_guard.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_kings_guard_aura", "items/items_thunder/kings_guard/item_kings_guard.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_kings_guard_aura_enemy", "items/items_thunder/kings_guard/item_kings_guard.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_kings_guard_aura:OnRemoved()
    if not IsServer() then return end
