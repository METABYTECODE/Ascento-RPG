LinkLuaModifier("modifier_chronos_hourglass", "items/items_thunder/chronos_hourglass/item_chronos_hourglass.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_chronos_hourglass_effect", "items/items_thunder/chronos_hourglass/item_chronos_hourglass.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_chronos_hourglass_aura", "items/items_thunder/chronos_hourglass/item_chronos_hourglass.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_chronos_hourglass_butterfly_effect", "items/items_thunder/chronos_hourglass/item_chronos_hourglass.lua", LUA_MODIFIER_MOTION_NONE)
