LinkLuaModifier("modifier_aeon_of_tarrasque", "items/items_thunder/aeon_of_tarrasque/item_aeon_of_tarrasque.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_aeon_of_tarrasque_immunity", "items/items_thunder/aeon_of_tarrasque/item_aeon_of_tarrasque.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_aeon_of_tarrasque_cooldown", "items/items_thunder/aeon_of_tarrasque/item_aeon_of_tarrasque.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_aeon_of_tarrasque:OnTakeDamage(event)
     ...
     if not victim or not attacker or not UnitIsNotMonkeyClone(attacker) or attacker:IsIllusion() or attacker == victim or not victim:IsRealHero() or not ability:IsCooldownReady() or victim:HasModifier("modifier_aeon_of_tarrasque_cooldown") then return end
