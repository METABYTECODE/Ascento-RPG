LinkLuaModifier("modifier_jagged_blade", "items/items_thunder/item_jagged_blade/item_jagged_blade.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_jagged_blade_debuff", "items/items_thunder/item_jagged_blade/item_jagged_blade.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_jagged_blade_disarmor", "items/items_thunder/item_jagged_blade/item_jagged_blade.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_jagged_blade_debuff:HandleCustomTransmitterData(data)
    if data.pctArmor ~= nil and data.baseArmor ~= nil then
...
function modifier_jagged_blade_debuff:GetModifierPhysicalArmorBonus()
    return self.fBaseArmor + self.fPctArmor
end
------------
