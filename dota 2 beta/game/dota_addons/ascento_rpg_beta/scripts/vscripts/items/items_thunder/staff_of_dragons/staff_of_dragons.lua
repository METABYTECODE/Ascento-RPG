LinkLuaModifier("modifier_item_staff_of_dragons", "items/items_thunder/staff_of_dragons/staff_of_dragons.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_staff_of_dragons_debuff", "items/items_thunder/staff_of_dragons/staff_of_dragons.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_staff_of_dragons_debuff_burning", "items/items_thunder/staff_of_dragons/staff_of_dragons.lua", LUA_MODIFIER_MOTION_NONE)
