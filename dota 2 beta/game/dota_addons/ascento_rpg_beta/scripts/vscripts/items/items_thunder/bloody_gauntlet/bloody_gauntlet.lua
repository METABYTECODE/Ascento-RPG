LinkLuaModifier("modifier_item_bloody_gauntlet", "items/items_thunder/bloody_gauntlet/bloody_gauntlet.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_bloody_gauntlet_active", "items/items_thunder/bloody_gauntlet/bloody_gauntlet.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_bloody_gauntlet_emitter", "items/items_thunder/bloody_gauntlet/bloody_gauntlet.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_bloody_gauntlet_emitter_aura", "items/items_thunder/bloody_gauntlet/bloody_gauntlet.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_item_bloody_gauntlet_emitter:GetAuraEntityReject(ent)
    if not ent:IsRealHero() then return true end
