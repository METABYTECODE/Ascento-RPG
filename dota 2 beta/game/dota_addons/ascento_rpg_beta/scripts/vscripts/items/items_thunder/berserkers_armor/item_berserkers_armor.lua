LinkLuaModifier("modifier_berserkers_armor", "items/items_thunder/berserkers_armor/item_berserkers_armor.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_berserkers_armor_toggle", "items/items_thunder/berserkers_armor/item_berserkers_armor.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_berserkers_armor_enrage", "items/items_thunder/berserkers_armor/item_berserkers_armor.lua", LUA_MODIFIER_MOTION_NONE)
