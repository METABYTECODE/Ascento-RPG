LinkLuaModifier("modifier_item_refreshing_spring_water", "items/items_thunder/item_refreshing_spring_water/item_refreshing_spring_water.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_refreshing_spring_water_buff", "items/items_thunder/item_refreshing_spring_water/item_refreshing_spring_water.lua", LUA_MODIFIER_MOTION_NONE)
