LinkLuaModifier("modifier_item_blood_drainer", "items/items_thunder/item_blood_drainer/item_blood_drainer.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_blood_drainer_toggle", "items/items_thunder/item_blood_drainer/item_blood_drainer.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_blood_drainer_particle", "items/items_thunder/item_blood_drainer/item_blood_drainer.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_item_blood_drainer_toggle:OnIntervalThink()
    ...
    local resMult = 1 - parent:GetMagicalArmorValue()
