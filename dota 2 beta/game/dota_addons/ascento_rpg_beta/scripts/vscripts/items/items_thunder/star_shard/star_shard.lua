...
LinkLuaModifier("modifier_item_star_shard", "items/items_thunder/star_shard/star_shard.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_star_shard_active", "items/items_thunder/star_shard/star_shard.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_star_shard_debuff", "items/items_thunder/star_shard/star_shard.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_item_star_shard_active:OnCreated()
    ...
    self.damage = self.attacker:GetMaxMana() * (self.ability:GetSpecialValueFor("active_agi_as_damage_pct")/100)
