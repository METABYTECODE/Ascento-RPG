...
LinkLuaModifier("modifier_item_enchanted_armor", "items/items_thunder/enchanted_armor.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_enchanted_armor_shield", "items/items_thunder/enchanted_armor.lua", LUA_MODIFIER_MOTION_NONE)
