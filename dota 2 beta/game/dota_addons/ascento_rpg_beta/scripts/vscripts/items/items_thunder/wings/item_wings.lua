LinkLuaModifier("modifier_item_wings", "items/items_thunder/wings/item_wings.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_wings_active", "items/items_thunder/wings/item_wings.lua", LUA_MODIFIER_MOTION_NONE)
