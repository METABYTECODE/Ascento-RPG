LinkLuaModifier("modifier_burning_blades", "items/items_thunder/burning_blades/item_burning_blades.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_burning_blades_aura_enemy", "items/items_thunder/burning_blades/item_burning_blades.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_burning_blades_explosion_debuff", "items/items_thunder/burning_blades/item_burning_blades.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_burning_blades_active", "items/items_thunder/burning_blades/item_burning_blades.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_burning_blades_aura_enemy:OnCreated()
    ...
    self.damageTable = {
        ...
        attacker = self:GetCaster(),
        damage = (self:GetAbility():GetSpecialValueFor("flat_burn") + (self:GetCaster():GetAverageTrueAttackDamage(self:GetCaster()) * (self.burn/100))) * 0.25,
        damage_type = DAMAGE_TYPE_MAGICAL,
        ability = ability,
    }
