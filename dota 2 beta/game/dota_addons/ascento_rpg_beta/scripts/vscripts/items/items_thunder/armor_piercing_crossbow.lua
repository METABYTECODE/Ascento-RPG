LinkLuaModifier("modifier_item_armor_piercing_crossbow", "items/items_thunder/armor_piercing_crossbow.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_armor_piercing_crossbow_debuff", "items/items_thunder/armor_piercing_crossbow.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_armor_piercing_crossbow_active", "items/items_thunder/armor_piercing_crossbow.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_armor_piercing_crossbow_dawn_debuff", "items/items_thunder/armor_piercing_crossbow.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_item_armor_piercing_crossbow:GetModifierPreAttack_CriticalStrike(keys)
    ...
    if RollPercentage(crit) then
        local victimArmor = keys.target:GetPhysicalArmorBaseValue()
        local reducedArmor = victimArmor * (ability:GetSpecialValueFor("ignore_armor_pct")/100)

        keys.target:AddNewModifier(unit, ability, "modifier_item_armor_piercing_crossbow_debuff", {
            duration = 1.5,
            armor = -reducedArmor
        })
