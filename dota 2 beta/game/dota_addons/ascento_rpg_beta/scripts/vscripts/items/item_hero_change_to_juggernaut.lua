function ChangeHero ( keys )
	...
	local item_to_remove = caster:FindItemInInventory("item_hero_change_to_juggernaut")
	...
	if caster:GetUnitName() ~= "npc_dota_hero_juggernaut" then
        new_hero = PlayerResource:ReplaceHeroWith(caster:GetPlayerOwnerID(), "npc_dota_hero_juggernaut", PlayerResource:GetGold(caster:GetPlayerOwnerID()), 0)
    end
