function ChangeHero ( keys )
	...
	local item_to_remove = caster:FindItemInInventory("item_hero_change_to_rubick")
	...
	if caster:GetUnitName() ~= "npc_dota_hero_rubick" then
        new_hero = PlayerResource:ReplaceHeroWith(caster:GetPlayerOwnerID(), "npc_dota_hero_rubick", PlayerResource:GetGold(caster:GetPlayerOwnerID()), 0)
    end
